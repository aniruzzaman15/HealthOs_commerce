              ...
              <a
                ...
                className={
                  item.id === activeComponent.id
                    ? "flex gap-x-4 items-center py-2 text-gray-500   text-indigo-600 group"
                    : "flex gap-x-4 items-center py-2 text-gray-500"
                }
              >
                <span
                  className={
                    item.id === activeComponent.id
                      ? "absolute w-1.5 h-8 bg-indigo-600 rounded-r-full left-0 scale-y-0 -translate-x-full scale-y-100 translate-x-0 transition-transform ease-in-out"
                      : "absolute w-1.5 h-8 bg-indigo-600 rounded-r-full left-0 scale-y-0 -translate-x-full "
                  }
                />
