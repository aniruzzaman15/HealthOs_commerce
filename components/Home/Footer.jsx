...
function Footer() {
  return (
    <footer className="p-4 bg-white sm:p-6 d">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href="" className="flex items-center">

                <span className="self-center text-2xl font-semibold whitespace-nowrap ">HealthOs Commerce</span>
            </a>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="" className="hover:underline">Health0s-commerce</a>
                    </li>
                    <li>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center ">© 2022 <a href="" className="hover:underline">HealthOs</a>. All Rights Reserved.
        </span>
